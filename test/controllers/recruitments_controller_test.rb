...
class RecruitmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get search" do
    get recruitments_search_url
    assert_response :success
  end

  test "should get search_result" do
    get recruitments_search_result_url
    assert_response :success
  end
  ...
  test "should get new_subscription" do
    get recruitments_new_subscription_url
    assert_response :success
  end
  ...
  test "should get edit_subscription" do
    get recruitments_edit_subscription_url
    assert_response :success
  end
